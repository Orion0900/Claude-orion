 ...
 * junctions are — so the worst fixes tend to arrive at the moment a rider
 * turns. Left unfiltered they drag the map somewhere the rider is not.
 *
...
/**
 * Faster than any cyclist, with room for honest error. A fix implying more
 * than this (about 100 km/h) did not come from someone on a bike, even on the
 * steepest descent.
 */
